...
# Wing Location Details Plugin Build Script
# Creates production-ready plugin package

PLUGIN_NAME="wing-location-details"
...
rm -rf build-temp
mkdir -p "${BUILD_DIR}/build/wing-location-details"
...
cp build/wing-location-details/* "${BUILD_DIR}/build/wing-location-details/"
